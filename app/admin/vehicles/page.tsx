  ...
  return (
    <div>
      ...
      <form
        ...
        className="bg-white border border-zinc-200 rounded-2xl p-4 mb-6 grid grid-cols-1 sm:grid-cols-6 gap-3"
      >
        <select name="resident_id" required className="bg-white rounded px-3 py-2 border border-zinc-200">
        ...
        <input
          ...
          required
          className="bg-white rounded px-3 py-2 border border-zinc-200 uppercase"
          style={{ textTransform: "uppercase" }}
        />
        <input name="make" placeholder="Marca" className="bg-white rounded px-3 py-2 border border-zinc-200" />
        <input name="model" placeholder="Modelo" className="bg-white rounded px-3 py-2 border border-zinc-200" />
        <input name="color" placeholder="Color" className="bg-white rounded px-3 py-2 border border-zinc-200" />
            ...
            {(vehiclesResp.data ?? []).map((v) => {
              ...
              return (
                <tr key={v.id} className="border-t border-zinc-200">
                  ...
                  <td className="px-4 py-3 text-zinc-700">{v.color ?? "—"}</td>
