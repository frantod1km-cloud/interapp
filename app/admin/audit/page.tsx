...
const ACTION_LABEL: Record<string, { label: string; className: string }> = {
  "org.suspend": { label: "Suspensión de org", className: "text-rose-300" },
  ...
  "resident.deactivate": { label: "Baja de residente", className: "text-amber-300" },
  ...
  "guard.remove": { label: "Baja de guardia", className: "text-rose-300" },
  "vehicle.create": { label: "Alta de vehículo", className: "text-emerald-400" },
  "vehicle.remove": { label: "Baja de vehículo", className: "text-amber-300" },
  "package.create": { label: "Paquete recibido", className: "text-sky-300" },
  "package.deliver": { label: "Paquete entregado", className: "text-emerald-400" },
  "package.return": { label: "Paquete devuelto", className: "text-amber-300" },
  "authorization.create": { label: "Autorización creada", className: "text-emerald-400" },
  "authorization.revoke": { label: "Autorización revocada", className: "text-amber-300" },
  "access_event.forced": { label: "Ingreso forzado", className: "text-amber-300" },
  "subscription.status_change": { label: "Cambio de suscripción", className: "text-sky-300" },
};
