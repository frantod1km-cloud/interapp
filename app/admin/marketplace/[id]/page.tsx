...
export default async function AdminListingDetailPage({
  ...
  return (
    <div>
      <Link href="/admin/marketplace" className="text-sm text-zinc-500 hover:text-zinc-300 inline-block mb-4">
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl overflow-hidden mb-6">
        ...
        <div className="p-6">
          <div className="flex items-center gap-2 mb-2 flex-wrap">
            ...
            {!listing.active && (
              <span className="text-xs px-2 py-1 rounded bg-rose-700/20 text-rose-400">Inactivo</span>
            )}
          </div>
      ...
      {!reservations || reservations.length === 0 ? (
        <p className="text-zinc-500 text-sm bg-zinc-900 border border-zinc-800 rounded-2xl p-6 text-center">
                ...
                return (
                  <tr key={r.id} className="border-t border-zinc-800">
                    ...
                    <td className="px-4 py-3">
                      ...
                      {res?.unit && <span className="text-zinc-500"> · {res.unit}</span>}
                    </td>
