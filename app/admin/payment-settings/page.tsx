...
export default async function PaymentSettingsPage({
  ...
  return (
    <div className="max-w-2xl">
      ...
      <form action={savePaymentSettingsAction} className="bg-white border border-zinc-200 rounded-2xl p-6 space-y-4">
        <div>
          <label className="block text-sm mb-1 text-zinc-700">Access Token</label>
          <input
            type="password"
        ...
        <div>
          <label className="block text-sm mb-1 text-zinc-700">Public Key</label>
          <input
            type="text"
            name="mp_public_key"
        ...
        <div>
          <label className="block text-sm mb-1 text-zinc-700">Email de notificaciones (opcional)</label>
          <input
            type="email"
            name="notify_emails"
        ...
        <button type="submit" className="w-full bg-blue-600 hover:bg-blue-500 font-semibold py-3 rounded-xl">
