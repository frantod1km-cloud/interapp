  ...
  return (
    <div>
      ...
      <form
        ...
        className="bg-white border border-zinc-200 rounded-2xl p-4 mb-6 grid grid-cols-1 sm:grid-cols-7 gap-3"
      >
        <select name="kind" defaultValue="owner" className="bg-white rounded px-3 py-2 border border-zinc-200">
          {RESIDENT_KINDS.map((k) => (
        ...
        <input name="dni" placeholder="DNI" required className="bg-white rounded px-3 py-2 border border-zinc-200" />
        <input name="first_name" placeholder="Nombre" required className="bg-white rounded px-3 py-2 border border-zinc-200" />
        <input name="last_name" placeholder="Apellido" required className="bg-white rounded px-3 py-2 border border-zinc-200" />
        <input name="unit" placeholder="Lote / Depto" className="bg-white rounded px-3 py-2 border border-zinc-200" />
        <input name="phone" placeholder="Teléfono" className="bg-white rounded px-3 py-2 border border-zinc-200" />
                ...
                <tr key={r.id} className="border-t border-zinc-200">
                  ...
                  <td className="px-4 py-3 text-zinc-700">
                    {email ? (
                      ...
                      <span className="text-zinc-700">Sin cuenta</span>
                    )}
                  </td>
                  <td className="px-4 py-3">
                    {r.active ? (
                      ...
                      <span className="text-zinc-700">Inactivo</span>
                    )}
                  </td>
  ...
  return (
    <Link
      ...
      className={`text-xs px-3 py-1.5 rounded-full border ${
        active
          ? "bg-emerald-600 border-emerald-500 text-zinc-900"
