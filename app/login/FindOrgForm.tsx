  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-zinc-950 text-white p-6">
      <form onSubmit={onSubmit} className="w-full max-w-md space-y-4">
        <Link href="/" className="text-sm text-zinc-400 hover:text-zinc-400 inline-block mb-2">
          ← Volver
        </Link>
        ...
        <div>
          ...
          <div className="flex items-center bg-zinc-900 border border-zinc-800 rounded-lg overflow-hidden">
            ...
            />
            <span className="text-zinc-400 pr-4 text-sm">.{rootDomain}</span>
          </div>
          <p className="text-xs text-zinc-400 mt-1">
            Ejemplo: si tu barrio es <code className="bg-zinc-900 border border-zinc-800 px-1 rounded">{exampleUrl}</code>, escribí <code className="bg-zinc-900 border border-zinc-800 px-1 rounded">test</code>.
          </p>
        </div>
        ...
        <div className="pt-4 border-t border-zinc-800 text-center text-sm text-zinc-400">
          ¿Todavía no tenés barrio?{" "}
          <Link href="/signup" className="text-emerald-400 hover:text-emerald-400 font-medium">
            Creá uno gratis
          </Link>
        </div>
      </form>
