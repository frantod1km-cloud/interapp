        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-8">
              ...
              <a
                href="#como-funciona"
                className="bg-zinc-900 border border-zinc-800 hover:bg-zinc-800 border border-zinc-800 font-semibold px-6 py-3.5 rounded-xl text-center"
              >
                Ver cómo funciona
              </a>
            </div>
    ...
    <div className="relative">
      ...
      <div className="relative bg-zinc-900 border border-zinc-800 rounded-2xl overflow-hidden shadow-2xl">
        <div className="flex items-center gap-2 px-4 py-2 bg-black/40 border-b border-zinc-800">
          ...
          <div className="flex-1 text-center text-xs text-zinc-400">losalamos.interapp.com/guard</div>
        </div>
        <div className="bg-emerald-600 p-10 text-center">
          ...
          <div className="mt-4">
            <button className="bg-zinc-950 text-emerald-400 font-bold text-lg px-8 py-3 rounded-xl shadow">
              Registrar entrada
            </button>
          </div>
        </div>
...
function HowItWorks() {
  ...
  return (
    <section id="como-funciona" className="py-20 border-t border-zinc-800">
      <div className="max-w-6xl mx-auto px-6">
        <div className="max-w-3xl mb-12">
...
function Pricing() {
  return (
    <section id="precios" className="py-20 border-t border-zinc-800">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {PUBLIC_PLAN_IDS.map((id) => {
            ...
            return (
              <div
                key={id}
                className={`relative bg-zinc-950 border rounded-2xl p-6 flex flex-col ${
              ...
              >
                ...
                <div className="text-xs uppercase tracking-wider text-zinc-400 mb-1">{plan.name}</div>
...
function Faq() {
  ...
  return (
    <section id="faq" className="py-20 border-t border-zinc-800">
...
function Footer() {
  return (
    <footer className="border-t border-zinc-800 py-10 mt-10">
